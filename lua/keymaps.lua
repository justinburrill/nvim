...
vim.keymap.set("n", "<leader>pc", ":Pick git_hunks scope='unstaged'<CR>", { desc = "Pick unstaged changes" })
vim.keymap.set("n", "<leader>pC", ":Pick git_hunks scope='staged'<CR>", { desc = "Pick staged changes" })
...
-- my keybinds !!
vim.keymap.set("n", "<leader>rc", "p`[v`]\"+d", { desc = "Re-copy (\"+)" })
